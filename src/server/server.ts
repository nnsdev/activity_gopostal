import { ACTIVITY_NAME, BOXES_PER_ZONE, ZONE_AMOUNT, VEHICLE } from '../common/config';
import { JobData, RpcCallback } from '../common/types';
...
const activatedAreas = letterboxes
